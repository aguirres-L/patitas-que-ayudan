  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
       ...
       <DetailPagoChapita obtenerColorEstado={obtenerColorEstado}  pagosChapitas={pagosChapitas} typeTheme={typeTheme} isCargandoPagos={isCargandoPagos} formatearMoneda={formatearMoneda} formatearFecha={formatearFecha} />
